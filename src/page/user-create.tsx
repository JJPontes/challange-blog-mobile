...
export default function UserCreate() {
  ...
  const handleFormSubmit = async (values: any) => {
    try {
      const payload = {
        ...values,
        // Remove a máscara antes de enviar para o backend (envia apenas números)
            ...
            <View className="bg-white rounded-md p-6 w-full max-w-[500px] self-center mx-4 shadow-sm">
              ...
              <View className="mb-4">
                ...
                <TextInput
                  ...
                  maxLength={15}
                  // IMPORTANTE: use o value do Formik
                  value={values.phone}
                  // Use onBlur para ajudar o Formik a rastrear o campo
                  onBlur={handleBlur('phone')}
                  // Intercepta e formata
                  onChangeText={text => {
                    const formatted = maskPhone(text);
                    // Só chama o setFieldValue se o valor mudar para evitar loops infinitos
